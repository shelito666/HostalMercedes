...
namespace Prueba21.Migrations
{
    ...
    [Migration("20250224104102_ImplementoMaestr2")]
    partial class ImplementoMaestr2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prueba21.Maestro_Detalle.DetalleHospedaje", b =>
                {
                    b.Property<int>("DetalleHospedajeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DetalleHospedajeId"));
                    ...
                    b.HasKey("DetalleHospedajeId");

                    b.HasIndex("HabitacionId");

                    b.HasIndex("OrdenHospedajeId");

                    b.ToTable("DetallesHospedaje");
                });
            ...
            modelBuilder.Entity("Prueba21.Maestro_Detalle.DetalleHospedaje", b =>
                {
                    b.HasOne("Prueba21.Models.Habitacion", "Habitacion")
                        .WithMany("DetallesHospedaje")
                        .HasForeignKey("HabitacionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Prueba21.Models.OrdenHospedaje", "OrdenHospedaje")
                        .WithMany("DetallesHospedaje")
                        .HasForeignKey("OrdenHospedajeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("Habitacion");

                    b.Navigation("OrdenHospedaje");
                });
            ...
            modelBuilder.Entity("Prueba21.Models.OrdenHospedaje", b =>
                {
                    ...
                    b.HasOne("Prueba21.Models.Habitacion", null)
                        .WithMany("OrdenesHospedaje")
                        .HasForeignKey("HabitacionId");
            ...
            modelBuilder.Entity("Prueba21.Models.Habitacion", b =>
                {
                    b.Navigation("DetallesHospedaje");
